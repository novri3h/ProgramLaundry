...
Adodc1.RecordSource = "Transaksi1"
...
'memanggil nomor pesanan yang belum dikirimkan
Call BukaDB
...
'prosedur untuk memanggil nomor kirim otomatis dengan pola KYYMMDD999
Private Sub Autokrm()
Call BukaDB
...
'prosedur untuk memanggil data penyerahan cucian berdasarkan nomornya yang dipilih dalam combo
...
If Not RSPesanan.EOF Then
    ...
    'memanggil data pesanan tersebut dilakukan dengan cara queri ke tabel pesanan, detail pesanan yang nomor pesanannya dipilih dalam combo, kemudian datanya ditampilkan dalam grid
    JmlItem = Val(RSPesanan!TotalItem)
    NomorKsm = RSPesanan!NomorKsm
    Dim RS As New ADODB.Recordset
    RS.Open "select barang.kodebrg,barang.namabrg,barang.Tarif,jumlahpsn,detailpsn.Tarif*jumlahpsn as total  from barang,detailpsn where left(nomorpsn,10)='" & Combo1 & "' and barang.kodebrg=detailpsn.kodebrg", Conn
    Call Tabel_Kosong
    RS.MoveFirst
    Nomor = 0
    Do While Not RS.EOF
        ...
        Adodc1.Recordset!Kode = RS!Kodebrg
        Adodc1.Recordset!Nama = RS!NamaBrg
        Adodc1.Recordset!Harga = RS!Tarif
        Adodc1.Recordset!Jumlah = RS!JumlahPsn
        Adodc1.Recordset!Total = RS!Total
...
'validasi petugas pengirim cucian
...
Private Sub CmdSimpan_Click()
    ...
    Do While Not Adodc1.Recordset.EOF
        ...
        SimpanDetailPsn = "Insert Into Detailkrm(Nomorkrm,KodeBrg,Tarif,Jumlahkrm) " & _
        "values ('" & Nomorkrm & "','" & Adodc1.Recordset!Kode & "','" & Adodc1.Recordset!Harga & "','" & Adodc1.Recordset!Jumlah & "')"
