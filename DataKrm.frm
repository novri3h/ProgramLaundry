...
Begin VB.Form DataKrm 
   Caption         =   "Data Pengiriman Cucian"
   ClientHeight    =   4425
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   8085
...
Adodc1.RecordSource = "select NamaBrg as [Nama Barang], detailkrm.Tarif as Harga,JumlahKrm as Jumlah, detailkrm.Tarif*JumlahKrm as Total from Barang,DetailKrm where DetailKrm.kodeBrg=Barang.kodeBrg and NomorKrm='" & List1.Text & "'"
Adodc1.Refresh
